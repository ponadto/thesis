...
% Napisz o tym, ze wsp. reakcji jest czesto brana ad hoc, przez co male zmiany potrafia miec gigantyczne znaczenia dla PMFa, co z kolei szkodliwie wplywa na procedury wymierzone 
%	w efektywne przeczesywanie wartosci wsp. reakcji, w ktorych PMF sie nie stabilizuje.
% Napisz, ze mozna wiele ugrac, jesli znalazlaby sie metoda z ML, ktorej funkcja celu byloby jak najlepiej rozciagniety PMF ze wzlgedu na jakis collective variable.
% Jeszcze jeden pomysl: uzycie reinforcement learning w celu eksploracji przestrzeni konfiguracyjnej.
% Albo inaczej: wykorzystanie reinforcement learningu do znalezienia automatycznego opisu, ktorego jakosc (SCORE) odzwierciedlalby sensownosc uzywania roznych kawalkow
%	czasteczki w celu okreslenia przebiegu reakcji / przejscia konfiguracyjnego.
